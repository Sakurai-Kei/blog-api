...
import aboutPicture from "../public/danteOutfit.png";

export default function newFunction() {
  return (
    <div className="mt-8 lg:mt-0 lg:w-1/2">
      <div className="flex items-center justify-center lg:justify-end">
        <div className="block max-w-lg overflow-hidden rounded-lg shadow-lg">
          <Image src={aboutPicture} alt="Sakurai Kei" layout="responsive" />
          ...
          <div className="px-6 py-4">
            ...
            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
              ...
              <h1 className="px-2 text-sm">luqmanulraiserhakim@gmail.com</h1>
            </div>
          </div>
        </div>
      </div>
